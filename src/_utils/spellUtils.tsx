...
export const filterSpellObjectByCharacter = (character: Character, spells: SpellObject): SpellObject => {
    ...
    Object.keys(spells).forEach((x: string) => {
        ...
        } else if(character.classes.some(cls => cls.name === CharacterClassNames.Sorcerer || cls.name === CharacterClassNames.Wizard)){
            {/* @ts-ignore */}
            filteredSpellObject[CharacterClassNames.SorcWiz] = spells[CharacterClassNames.SorcWiz]
        }
    })
