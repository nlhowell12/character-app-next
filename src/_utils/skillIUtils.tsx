...
import { getDazzledModifiers, getFascinatedModifiers, getFearModifiers } from './statusEffectUtils';
...
export const getTotalSkillMod = (
	...
	const statusEffectMods = [...getDazzledModifiers(character), ...getFascinatedModifiers(character, skill.name), ...getFearModifiers(character, skill.name)]
