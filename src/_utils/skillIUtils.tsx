...
import { getDazzledModifiers, getFascinatedModifiers } from './statusEffectUtils';
...
export const getTotalSkillMod = (
	...
	const statusEffectMods = [...getDazzledModifiers(character), ...getFascinatedModifiers(character, skill.name)]
