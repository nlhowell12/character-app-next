...
export const DomainAspectsTable = ({
    ...
    const allegianceTotals = useMemo(
        () => getAllegianceTotal(character),
        [character]
    );
    const sortedDomains = useMemo(
        () => sortDomainAspects(character),
        [character]
    );
                                    ...
                                    return (
                                        dom !== DivineDomain.Cosmic && (
                                            ...
                                            >
                                                <TableCell>
                                                    {!!preferredDomain ? (
                                                        <Tooltip title='Preferred Domain'>
                                                            <CheckCircle
                                                                color='primary'
                                                                sx={{
                                                                    width: '1rem',
